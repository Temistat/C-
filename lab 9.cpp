// Temiloluwa Omomuwasan section C Lab 9
...
public:
    //Task 5
    //TextBook(unsigned numPages) : Book(numPages) {}
    //Task 7
    TextBook(unsigned numPages, unsigned numIndPgs )
            : Book(numPages), numOfIndexPages(numIndPgs) {}
    //Task 14
    void displayNumPages() const {
        cout << "\nThis is a textbook.\n";
